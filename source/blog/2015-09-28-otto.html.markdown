...
* [Intro](https://ottoproject.io/intro/index.html) - The intro section explains in more detail what Vault is, how it works, what use cases it has, and includes a brief getting started guide so you can start experimenting with Vault and learn about all of its features.

* [Comparison to other software](https://ottoproject.io/intro/vs/index.html) - If you'd like to know how Vault is different from other options out there, take a look at this page and we go into detail on the differences.
